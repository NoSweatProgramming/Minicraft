...
import com.intermaticcore.minicraft.screen.DeadMenu;
import com.intermaticcore.minicraft.screen.LevelTransitionMenu;
import com.intermaticcore.minicraft.screen.Menu;
import com.intermaticcore.minicraft.screen.TitleMenu;
import com.intermaticcore.minicraft.screen.WonMenu;
...
public class Game extends Canvas implements Runnable {
	...
	public static void main(String[] args) {
		...
		ImageIcon img = new ImageIcon("res\\window-icon.png");
